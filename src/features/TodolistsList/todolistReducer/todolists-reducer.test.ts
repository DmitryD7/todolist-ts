...
test('correct todolist should be added', () => {
    ...
    let action = addTodolistTC.fulfilled({todolist: {id: 'todolistId', title: newTodolistTitle, addedDate: '', order: 0}}, 'requestId', {title: newTodolistTitle})
...
test('correct todolist should change his name', () => {
    ...
    const endState = todolistsReducer(startState, changeTodolistTitleTC.fulfilled({id: todolistId2, title: newTodolistTitle}, 'requestId', {todolistId: todolistId2, newTodolistTitle: newTodolistTitle}));
